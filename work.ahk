::.work::{
    ...
    Run("C:\Users\TheBestPessimist\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Slack Technologies Inc\Slack.lnk",,"Max")
    sleep 4000
    Run("D:\all\all\Vivaldi\Application\vivaldi.exe --profile-directory=`"Profile 11`"")
}
